...
public class Pm_departmentService extends HttpBodyHandler {
	...
	/*****************************耿明泽***********************************/
	@FunctionDescriber(shortName = "查询所有部门下的所有的用户", description = "暂无", prerequisite = "暂无")
	public com.cn.models.Pm_department queryDepartmentUsers() {
		return pm_departmentMapper.queryDepartmentUsers();
	}
	/*****************************耿明泽***********************************/
