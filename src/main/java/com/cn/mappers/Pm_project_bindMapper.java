...
public interface Pm_project_bindMapper {
	@Insert("INSERT INTO pm_project_bind(project_id,project_bd, prjoject_sup) VALUES(#{project_id},#{project_bd},#{project_sup})") 
	...
	public Pm_project_bind getPm_project_bind(@Param("project_id") Integer project_id);
	...
	public void updateProjectBind(Pm_project_bind pm_project_bind);
